...
namespace ERP.DAL
{
	...
	public partial class User
	{
		...
		public long Add(ERP.Model.User model)
		{
			...
			strSql.Append("Ident,Name,Description,Level,Department,password,ModifyUser)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@Department", SqlDbType.Char,15),
					new SqlParameter("@password", SqlDbType.Char,150),
		...
		public ERP.Model.User GetModel(long OID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 OID,Ident,Name,Description,Level,Department,password,ModifyUser from User ");
			strSql.Append(" where OID=@OID");
			SqlParameter[] parameters = {
					new SqlParameter("@OID", SqlDbType.BigInt)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public ERP.Model.User DataRowToModel(DataRow row)
		{
			ERP.Model.User model=new ERP.Model.User();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select OID,Ident,[Name],[Description],[Level],Department,[password],ModifyUser ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" OID,Ident,Name,Description,Level,Department,password,ModifyUser ");
			strSql.Append(" FROM User ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
