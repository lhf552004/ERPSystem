...
namespace ERP.BLL
{
	...
	{
		private readonly ERP.DAL.Receival dal=new ERP.DAL.Receival();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ERP.Model.Receival GetModelByCache(long OID)
		{
			
			string CacheKey = "ReceivalModel-" + OID;
			...
			return (ERP.Model.Receival)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ERP.Model.Receival> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ERP.Model.Receival> DataTableToList(DataTable dt)
		{
			List<ERP.Model.Receival> modelList = new List<ERP.Model.Receival>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ERP.Model.Receival model;
        ...
        /// <returns></returns>
        public DataSet GetAllIngredientCompoents(Model.Receival Model)
        {
    
            string strWhere = "Rec_OID = " +Model.OID;
        ...
        /// <param name="Model"></param>
        /// <returns></returns>
        public List<ERP.Model.IngredientCompoent> GetAllIngredientCompoentModels(Model.Receival Model)
        {
